		...
		function wdjewelry_woo_account(){
			...
			<div class='wd-login'>
				<div class='title_login'>
					...
					<?php else: ?>
						<span class="my_account_wrapper"><a href="<?php echo ($myaccount_page_id)? get_permalink( $myaccount_page_id ): admin_url( 'profile.php', 'http' ); ?>" title="<?php esc_html_e('Minha Conta','wdjewelry');?>"><?php esc_html_e('Minha Conta','wdjewelry');?></a></span>
						<span class="logout_wrapper"><a href="<?php echo wp_logout_url( get_permalink() ); ?>" title="<?php esc_html_e('Sair','wdjewelry');?>"><?php esc_html_e('Sair','wdjewelry');?></a></span>
					<?php endif; ?>
				</div>
