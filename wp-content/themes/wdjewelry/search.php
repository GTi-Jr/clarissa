					...
					<div class="wd-products-wrapper small_image">
						<?php if ( have_posts() ) : ?>
							<header class="page-header">
								<h1 class="page-title"><?php printf( esc_html__( 'Resultados para: %s', 'wdjewelry' ), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
							</header><!-- .page-header -->
							...
							the_posts_pagination( array(
								'prev_text'          => esc_html__( 'Próxima Anterior', 'wdjewelry' ),
								'next_text'          => esc_html__( 'Próxima Página', 'wdjewelry' ),
