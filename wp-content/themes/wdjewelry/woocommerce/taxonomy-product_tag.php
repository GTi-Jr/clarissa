...
get_header( 'shop' ); ?>
	<div class='Shop__content'>
		...
		<?php $col_content = (wdjewelry_check_layout('layout_tag_product')?'col-sm-18':'col-sm-24'); ?>
		<?php if(get_theme_mod( 'layout_banner_tag')): ?>
			<div class="shop__banner">
				<img src="<?php echo get_theme_mod( 'layout_banner_tag'); ?>" title='baner' >
			</div>
		<?php endif; ?>
		...
		<div class="row">
			...
			<?php
			if(get_theme_mod('layout_tag_product','sidebar-right') === 'sidebar-left'):
				echo '<div class="col-sm-6 sidebar sidebar__left">';
				wdjewelry_get_sidebar('sidebar_tag_product','layout_tag_product');
				echo '</div>';
			endif;
			?>
			...
			<?php
				if(get_theme_mod('layout_tag_product','sidebar-right') === 'sidebar-right'):
