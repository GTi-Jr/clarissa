...
<div id="primary" class="content-area">	
	<div id="main" class="site-main row" role="main">
		<?php $sub_class = (wdjewelry_check_layout('layout_template_second')?'col-sm-18':'col-sm-24'); ?>
		<!-- SHOW  SIDEBAR lEFT -->
		<?php
			if(get_theme_mod('layout_template_second') === 'sidebar-left'):
				echo '<div class="col-sm-6 sidebar sidebar__left">';
				wdjewelry_get_sidebar('sidebar_template_second','layout_template_second');
				echo '</div>';
			endif;
		?>
		...
		<?php
			if(get_theme_mod('layout_template_second') === 'sidebar-right'):
