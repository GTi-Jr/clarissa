		...
		class TS_Image_Hotspot {
			...
			function TS_VCSC_Image_Hotspot_Container ($atts, $content = null) {
				...
				if (!empty($hotspot_image)) {
					...
					$modal_retina					= wp_get_attachment_image_srcset($hotspot_image, 'full');
				}
				...
				if ($hotspot_frontend == "false") {
					if ($hotspot_break == "true") {
						...
						$output .= '<img class="ts-image-hotspot-image ' . ($hotspot_break == "true" ? "ts-imagefull" : "") . '" data-no-lazy="1" src="' . $modal_image[0] . '" srcset="' . $modal_retina . '">';
