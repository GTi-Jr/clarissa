<?php
	...
	if ($this->TS_VCSC_CustomPostTypesWidgets == "true") {
		function TS_VCSC_Widgets_Post_Type() {
			...
			$labels = array(
				'name'                  	=> __( 'VC Widgets / Templates', 'ts_visual_composer_extend' ),
				'singular_name'         	=> __( 'VC Widget / Template', 'ts_visual_composer_extend' ),
				'add_new'               	=> __( 'Add New', 'ts_visual_composer_extend' ),
				'add_new_item'          	=> __( 'Add New VC Widget / Template', 'ts_visual_composer_extend' ),
				'edit_item'             	=> __( 'Edit VC Widget / Template', 'ts_visual_composer_extend' ),
				'new_item'              	=> __( 'New VC Widget / Template', 'ts_visual_composer_extend' ),
				'view_item'             	=> __( 'View VC Widget / Template', 'ts_visual_composer_extend' ),
				'search_items'          	=> __( 'Search VC Widgets / Templates', 'ts_visual_composer_extend' ),
				'not_found'             	=> __( 'No VC Widgets / Templates found', 'ts_visual_composer_extend' ),
				'not_found_in_trash'    	=> __( 'No VC Widgets / Templates found in the Trash', 'ts_visual_composer_extend' ), 
				'parent_item_colon'     	=> '',
				'menu_name'             	=> 'VC Widgets'
			);
			$args = array(
				'labels'                	=> $labels,
				'description'           	=> __( "Add VC Widgets / Templates to be used in sidebars or posts/pages via Visual Composer.", 'ts_visual_composer_extend' ),
				'public'                	=> true, //false
		...
		function TS_VCSC_Widgets_Post_Composer() {
		...
		if (defined('WPB_VC_VERSION')){
			if (TS_VCSC_VersionCompare(WPB_VC_VERSION, '4.8.0') >= 0) {
				// Currently No Action Available
			} else {
				add_action('init', 'TS_VCSC_Widgets_Post_Composer', 77777777);
			}
		}
