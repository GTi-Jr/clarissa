							...
							<table id="ts_tiny_tinymce_table_close" class="ts_tiny_form ts_tiny_table ts_tiny_tinymce_table_close" cellspacing="0" style="">
								...
								<tr class="tbl_last">
									<td colspan="2" style="width: 100%;">
										...
										<input style="margin-top: 10px; margin-bottom: 10px; float: right;" type="button" value="<?php _e( "Close", "ts_visual_composer_extend" ); ?>" name="ts_tiny_close_icon" id="ts_tiny_close_icon" class="button-secondary" />
									</td>    
								</tr>
							</table>
						</form>
