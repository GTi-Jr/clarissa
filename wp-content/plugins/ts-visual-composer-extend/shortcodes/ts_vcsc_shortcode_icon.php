<?php
	...
	function TS_VCSC_Font_Icons_Function ($atts) {
		...
		$output .= '<div id="' . $icon_font_id . '" style="" class="' . $css_class . ' ' . ($animation_view != '' ? 'ts-vcsc-font-icon-viewport' : '') . '" data-type="' . ($icon_replace == "false" ? "icon" : "image") . '" data-viewport="' . $animation_css . '" data-opacity="1" data-delay="' . $animation_delay . '" data-animation="' . $animation_icon . '">';		
			if ($link) {
