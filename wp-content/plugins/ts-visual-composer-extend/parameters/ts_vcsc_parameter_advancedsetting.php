    ...
    if (!class_exists('TS_Parameter_AdvancedStyling')) {
        class TS_Parameter_AdvancedStyling {
            ...
            function advanced_styling_settings_field($settings, $value) {
                ...
                // Build Parameter
                $html = '<div id="' . $random_id_container . '" class="ts-advanced-styling ts-settings-parameter-gradient-grey" data-type="' . $style_type . '" data-show-main="' . $show_main . '" data-show-preview="' . $show_preview . '" data-show-side="true" data-show-radius="' . $show_radius . '" data-show-style="' . $show_style . '" data-show-color="' . $show_color . '" data-show-unit-width="' . $show_unit_width . '" data-show-unit-radius="' . $show_unit_radius . '">';
                    // Preview Container
