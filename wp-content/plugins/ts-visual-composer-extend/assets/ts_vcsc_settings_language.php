...
<div id="ts-settings-language" class="tab-content">
	...
	<div class="ts-vcsc-section-content slideFade" style="display: none;">
		...
		<input class="validate[required]" data-error="Text - Filter by Groups" data-order="2" type="text" style="width: 20%;" id="ts_vcsc_extend_settings_languageTextFilterLabel" name="ts_vcsc_extend_settings_languageTextFilterLabel" value="<?php echo (isset($TS_VCSC_Google_MapPLUS_Language['FilterLabel']) ? $TS_VCSC_Google_MapPLUS_Language['FilterLabel'] : $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_Google_MapPLUS_Language_Defaults['FilterLabel']); ?>" size="100">
	    </p>
	    <p>
		...
		<input class="validate[required]" data-error="Text - Search Location" data-order="2" type="text" style="width: 20%;" id="ts_vcsc_extend_settings_languageTextSearchButton" name="ts_vcsc_extend_settings_languageTextSearchButton" value="<?php echo (isset($TS_VCSC_Google_MapPLUS_Language['SearchButton']) ? $TS_VCSC_Google_MapPLUS_Language['SearchButton'] : $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_Google_MapPLUS_Language_Defaults['SearchButton']); ?>" size="100">
	    </p>
	    <p>
		...
		<input class="validate[required]" data-error="Text - Enter address to search for ..." data-order="2" type="text" style="width: 20%;" id="ts_vcsc_extend_settings_languageTextSearchHolder" name="ts_vcsc_extend_settings_languageTextSearchHolder" value="<?php echo (isset($TS_VCSC_Google_MapPLUS_Language['SearchHolder']) ? $TS_VCSC_Google_MapPLUS_Language['SearchHolder'] : $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_Google_MapPLUS_Language_Defaults['SearchHolder']); ?>" size="100">
	    </p>
	    <p>
		...
		<input class="validate[required]" data-error="Text - View on Google Maps" data-order="2" type="text" style="width: 20%;" id="ts_vcsc_extend_settings_languageTextSearchGoogle" name="ts_vcsc_extend_settings_languageTextSearchGoogle" value="<?php echo (isset($TS_VCSC_Google_MapPLUS_Language['SearchGoogle']) ? $TS_VCSC_Google_MapPLUS_Language['SearchGoogle'] : $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_Google_MapPLUS_Language_Defaults['SearchGoogle']); ?>" size="100">
	    </p>
	    <p>
